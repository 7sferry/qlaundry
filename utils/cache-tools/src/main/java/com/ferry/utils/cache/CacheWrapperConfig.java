...
import com.ferry.utils.cache.CacheWrapperListConfig.CacheWrapperListConfigBuilder;
...
@Builder
public record CacheWrapperConfig<T>(String key, Callable<T> function, Class<T> dataClass, Duration hardExpirationConfig,
	...
	public static <T> CacheWrapperConfigBuilder<T> with(String key, Callable<T> function, Class<T> dataClass,
